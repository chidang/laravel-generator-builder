...
<head>
    ...
    <title>Techamz Technologies</title>
    ...
    <section class="content">
        ...
        <div class="box box-primary col-lg-12">
            <div class="box-header" style="margin-top: 10px">
                <h1 class="box-title" style="font-size: 30px">Techamz Laravel Generator Builder</h1>
            </div>
            <div class="box-body">
                <form id="form">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select id="drdCommandType" class="form-control" style="width: 100%">
                            <option value="techamz:api_scaffold">API Scaffold Generator</option>
                            <option value="techamz:api">API Generator</option>
                            <option value="techamz:scaffold">Scaffold Generator</option>
                        </select>
                    </div>
                    <div class="form-group col-md-4">
