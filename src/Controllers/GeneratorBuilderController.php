...
namespace Techamz\GeneratorBuilder\Controllers;
...
use Techamz\GeneratorBuilder\Requests\BuilderGenerateRequest;
use Request;
use Response;
...
class GeneratorBuilderController extends Controller
{
    ...
    {
        return view(config('techamz.generator_builder.views.builder'));
    }

    public function fieldTemplate()
    {
        return view(config('techamz.generator_builder.views.field-template'));
    }

    public function relationFieldTemplate()
    {
        return view(config('techamz.generator_builder.views.relation-field-template'));
    }
    ...
    public function rollback()
    {
        ...
        Artisan::call('techamz:rollback', $input);
...
//    {
//        $schemaFolder = config('techamz.laravel_generator.path.schema_files', base_path('resources/model_schemas/'));
//
