...
namespace Techamz\GeneratorBuilder\Commands;
...
class GeneratorBuilderRoutesPublisherCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'techamz.publish:generator-builder';
    ...
    {
        $path = config('techamz.laravel_generator.path.routes', app_path('Http/routes.php'));
    ...
    public function publishViews()
    {
        ...
        $destinationDir = base_path('resources/views/techamz/generator-builder/');
